...
@Component({
  selector: 'app-mis-pedidos-clean',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './mis-pedidos-clean.component.html',
  styleUrls: ['./mis-pedidos-clean.component.css']
})
export class MisPedidosCleanComponent implements OnInit {
