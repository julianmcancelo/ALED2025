...
@Component({
  selector: 'app-mis-pedidos-simple',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './mis-pedidos-simple.component.html',
  styleUrls: ['./mis-pedidos-simple.component.css']
})
export class MisPedidosSimpleComponent implements OnInit {
